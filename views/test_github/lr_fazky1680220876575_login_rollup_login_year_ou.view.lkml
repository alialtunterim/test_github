# The name of this view in Looker is "Lr Fazky1680220876575 Login Rollup Login Year Ou"
view: lr_fazky1680220876575_login_rollup_login_year_ou {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `public.LR_FAZKY1680220876575_login_rollup_login_year_ou`
    ;;
