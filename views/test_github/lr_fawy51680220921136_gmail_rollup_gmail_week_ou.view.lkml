# The name of this view in Looker is "Lr Fawy51680220921136 Gmail Rollup Gmail Week Ou"
view: lr_fawy51680220921136_gmail_rollup_gmail_week_ou {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `public.LR_FAWY51680220921136_gmail_rollup_gmail_week_ou`
    ;;
