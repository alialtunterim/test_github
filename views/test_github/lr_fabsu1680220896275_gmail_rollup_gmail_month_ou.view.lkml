# The name of this view in Looker is "Lr Fabsu1680220896275 Gmail Rollup Gmail Month Ou"
view: lr_fabsu1680220896275_gmail_rollup_gmail_month_ou {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `public.LR_FABSU1680220896275_gmail_rollup_gmail_month_ou`
    ;;
