# The name of this view in Looker is "Lr Faj0 T1680220912691 Drive Rollup Drive Year Ou"
view: lr_faj0_t1680220912691_drive_rollup_drive_year_ou {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `public.LR_FAJ0T1680220912691_drive_rollup_drive_year_ou`
    ;;
