# The name of this view in Looker is "Lr Fauw81680220917500 Login Rollup Login Date Ou"
view: lr_fauw81680220917500_login_rollup_login_date_ou {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `public.LR_FAUW81680220917500_login_rollup_login_date_ou`
    ;;
  ...
  dimension_group: activity_activity {
    type: time
    timeframes: [
      raw,
      time,
    ...
    sql: ${TABLE}.activity_activity_date ;;
  }
